      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <div className="text-center">
            ...
            <p className="text-blue-200">Test ID: {testResults.id}</p>
          </div>
                  ...
                  >
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      ...
                      <div className="text-center p-4 bg-white/5 rounded-lg">
                        ...
                        <div className="text-blue-200 text-sm">AI Confidence</div>
                      </div>
                      <div className="text-center p-4 bg-white/5 rounded-lg">
                        <div className="text-3xl font-bold text-white mb-2">{testResults.detectedConditions.length}</div>
                        <div className="text-blue-200 text-sm">Conditions Detected</div>
                      </div>
                    </div>
