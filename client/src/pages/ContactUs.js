      ...
      <div className="max-w-7xl mx-auto px-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full p-3 rounded-lg bg-white/10 border border-white/20 text-white placeholder-blue-200 focus:outline-none focus:border-blue-400"
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows="6"
                  className="w-full p-3 rounded-lg bg-white/10 border border-white/20 text-white placeholder-blue-200 focus:outline-none focus:border-blue-400 resize-none"
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-blue-200">hello@eyehealth.ai</p>
                  </div>
                </div>
                <div className="flex items-center space-x-4">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-blue-200">24/7 Available</p>
                  </div>
                </div>
              </div>
            </div>
                ...
                {supportOptions.map((option, index) => (
                  <div key={index} className="p-4 bg-white/5 rounded-lg">
                    <div className="flex items-start space-x-3">
                      <div className="text-blue-300 mt-1">{option.icon}</div>
                      <div className="flex-1">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <span className="text-blue-200 text-xs">{option.response}</span>
                        </div>
                      </div>
                    </div>
                  </div>
        ...
        >
          <div className="text-center mb-12">
            ...
            <p className="text-blue-100">Visit us at one of our global locations</p>
          </div>
              ...
              >
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <p className="text-blue-200 text-sm">{office.email}</p>
                  </div>
                  <div className="flex items-center space-x-3">
                    <Clock className="w-4 h-4 text-blue-300 flex-shrink-0" />
                    <p className="text-blue-200 text-sm">{office.hours} ({office.timezone})</p>
                  </div>
                </div>
              </motion.div>
            ))}
