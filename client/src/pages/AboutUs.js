            ...
            {team.map((member, index) => (
              ...
              >
                <div className="text-center mb-6">
                  ...
                  <div className="flex items-center justify-center space-x-2 text-sm text-blue-200 mb-3">
                ...
                <div className="flex items-center justify-between pt-4 border-t border-white/10">
                  ...
                  <div className="flex space-x-2">
                    <a href={member.linkedin} className="text-blue-300 hover:text-white transition-colors">
                      <Linkedin className="w-4 h-4" />
                    </a>
                    <a href={member.twitter} className="text-blue-300 hover:text-white transition-colors">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="text-center">
                <div className="w-64 h-64 bg-gradient-to-br from-blue-400 to-purple-500 rounded-full mx-auto flex items-center justify-center mb-6">
